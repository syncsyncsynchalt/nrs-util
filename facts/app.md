...
- `windowed.js`: フルスクリーン抑止・1024x600 固定窓化（QoL）。`ChangeDisplaySettings*` をブロックし、
  ...
  `AdjustWindowRectEx` で client=1024x600（docs/teknoparrot.md の RingEdge HW 仕様）の外寸を逆算し w/h を上書き。
