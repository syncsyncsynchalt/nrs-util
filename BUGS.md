...
|---|---|---|---|
| 4 | FUN_00458fd0 / FUN_0045a7f0 | region | **✅ check-neutralization 化済 (2026-06-13)**: errCode 4 ストアを NOP10（0x59109/0x5A846）。mxkeychip/region.js。詳細 `docs/bugs_archive.md` |
...
| 1 | FUN_006f0a80 | — | mxkeychip/setup.js(KCHOLD) |
