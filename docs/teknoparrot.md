...
| amNet 応答・bind 先供給 | `boot/mxnetwork/state.js` + `pcpa_server.py` |
...
| IC Card/USB I/O/Touch/Network type/EXTEND/ALL.Net/P-ras | `boot/devices/*` / `boot/patches.json(0x6FF18A/AC/B3)` / `boot/mxsegaboot/*` / `boot/patches.json(0x72DCE0)` |
